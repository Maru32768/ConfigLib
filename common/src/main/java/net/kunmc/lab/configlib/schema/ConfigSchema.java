...
public final class ConfigSchema {
    ...
    // Keep the POJO API bounded: structured POJO sections are nested classes/records,
    // while custom scalar parsing and Minecraft-specific command behavior belong in Value types.
